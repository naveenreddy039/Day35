...
namespace LinqAddressBook
{
    class ABDatatable
    {
        ...
        public DataTable CreateTable(AddressBookModel model)
        {
            ...
            dataTable.Rows.Add("Mr", "Varun", "A", "VDP", "AP", "09", "12345", "lgvk@gmail.com", "Friends", "Office");
            dataTable.Rows.Add("MR", "RAM", "A", "VDP", "TN", "24", "654298452", "Ramulu@gmail.com", "Friends", "Home");
            dataTable.Rows.Add("sai", "kumar", "N", "tambaram", "TN", "07", "52404697", "lkg@gmail.com", "Friends", "Office");
            dataTable.Rows.Add("Pavan", "kumar", "T", "KPHB", "AP", "22", "26351", "ukg@gmail.com", "Friends", "Home");
            dataTable.Rows.Add("TIKU", "PAVAN", "T", "CHROMPET", "KA", "26", "984865", "gvkl@gmail.com", "Friends", "Home");
